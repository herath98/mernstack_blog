      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 sm:flex-row justify-between">
          <TextInput 
            ...
            id='title'
            className='flex-1'
            value={formData.title || ''} // Prefill with existing title
          ...
          <TextInput 
            ...
            id='category'
            value={formData.category?.join(', ') || ''} // Prefill with existing categories
        ...
        <ReactQuill 
          ...
          required 
          value={formData.content || ''} // Prefill with existing content
          onChange={(value) => setFormData({ ...formData, content: value })}
        />
        <Button type='submit' className='bg-gradient-to-r from-lime-500 via-cyan-500 to-violet-800 '>Update</Button>
